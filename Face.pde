//This file represents what linear algebra rules should be followed to determine the orientation of the cube
//Through a series of translations and rotations, each cubie is assigned a new position
class Face {
  PVector normal;
  color c;
